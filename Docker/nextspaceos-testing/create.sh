...
docker exec -w / -it nextspace-testing git clone https://github.com/WindowsXP95/NeXTSPACE-Live.git
docker exec -w /NeXTSPACE-OS -it nextspace-testing sh /NeXTSPACE-OS/testing/build_testing.sh
docker cp nextspace-testing:/NeXTSPACE-OS/NEXTSPACEOS.iso ~/NEXTSPACEOS.iso
