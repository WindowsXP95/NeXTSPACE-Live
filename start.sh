...
docker cp nextspace-testing:/NeXTSPACE-OS/nxt.iso ~/nextspaceos_rel-$(date +"%Y%m%d").iso
docker cp nextspace-testing:/NeXTSPACE-OS/nxtbeta.iso ~/nextspaceos_rel_beta-$(date +"%Y%m%d").iso
